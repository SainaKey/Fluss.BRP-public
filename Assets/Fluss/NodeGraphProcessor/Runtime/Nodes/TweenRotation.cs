...
{
    [Serializable]
    [NodeMenuItem("GameObject/TweenRotation")]
    public class TweenRotation : FlussNode
    {
        public override string name => "TweenRotation";
        ...
        private void Tween()
        {
            ...
            tweener = gameObject.transform.DOLocalRotate(targetPosition, duration).SetEase(ease);
        }
